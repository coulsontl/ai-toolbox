        ...
        match mapping.id.as_str() {
            ...
            "omp-models" => {
                if let Ok(path) = crate::coding::oh_my_pi::get_omp_models_path_async(db).await {
                    mapping.local_path = path.to_string_lossy().to_string();
                    mapping.remote_path = omp_remote_target_path(db, OMP_MODELS_FILE).await;
                }
            }
            "omp-mcp" => {
                if let Ok(path) = crate::coding::oh_my_pi::get_omp_mcp_path_async(db).await {
                    mapping.local_path = path.to_string_lossy().to_string();
                    mapping.remote_path = omp_remote_target_path(db, OMP_MCP_FILE).await;
                }
            }
            "omp-agents" => {
                if let Ok(path) = crate::coding::oh_my_pi::get_omp_prompt_path_async(db).await {
                    mapping.local_path = path.to_string_lossy().to_string();
                    mapping.remote_path = omp_remote_target_path(db, OMP_PROMPT_FILE).await;
                }
            }
            "omp-rules" => {
                if let Ok(location) =
            ...
            "dsh-config" | "dsh-credentials" | "dsh-prompt" | "dsh-mcp" => {
                    ...
                    crate::coding::dsh::get_dsh_config_dir_from_db_async(db).await
                {
                    ...
                    mapping.local_path = config_dir.join(file_name).to_string_lossy().to_string();
                    mapping.remote_path = format!("~/.dsh/{file_name}");
                }
            }
...
async fn omp_remote_target_path(db: &SqliteDbState, file_name: &str) -> String {
    runtime_location::get_oh_my_pi_runtime_location_async(db)
        .await
        .map(|location| omp_remote_target_path_from_location(&location, file_name))
...
pub fn default_file_mappings() -> Vec<SSHFileMapping> {
    vec![
        ...
        SSHFileMapping {
            ...
            local_path: "~/.grok/auth.json".to_string(),
            remote_path: "~/.grok/auth.json".to_string(),
            enabled: true,
            is_pattern: false,
            is_directory: false,
            directory_excludes: vec![],
        ...
        SSHFileMapping {
            ...
            module: "grok".to_string(),
            local_path: "~/.grok/config.toml".to_string(),
            remote_path: "~/.grok/config.toml".to_string(),
            enabled: true,
            is_pattern: false,
            is_directory: false,
            directory_excludes: vec![],
        ...
        SSHFileMapping {
            ...
            module: "grok".to_string(),
            local_path: "~/.grok/AGENTS.md".to_string(),
            remote_path: "~/.grok/AGENTS.md".to_string(),
            enabled: true,
            is_pattern: false,
            is_directory: false,
            directory_excludes: vec![],
        ...
        SSHFileMapping {
            ...
            module: "grok".to_string(),
            local_path: "~/.grok/plugins".to_string(),
            remote_path: "~/.grok/plugins".to_string(),
            enabled: true,
            is_pattern: false,
            is_directory: true,
            directory_excludes: super::types::default_directory_excludes(),
        ...
        SSHFileMapping {
            ...
            local_path: "~/.omp/agent/config.yml".to_string(),
            remote_path: "~/.omp/agent/config.yml".to_string(),
            enabled: true,
            is_pattern: false,
            is_directory: false,
            directory_excludes: vec![],
        ...
        SSHFileMapping {
            ...
            module: "oh_my_pi".to_string(),
            local_path: "~/.omp/agent/models.yml".to_string(),
            remote_path: "~/.omp/agent/models.yml".to_string(),
            enabled: true,
            is_pattern: false,
            is_directory: false,
            directory_excludes: vec![],
        ...
        SSHFileMapping {
            ...
            module: "oh_my_pi".to_string(),
            local_path: "~/.omp/agent/mcp.json".to_string(),
            remote_path: "~/.omp/agent/mcp.json".to_string(),
            enabled: true,
            is_pattern: false,
            is_directory: false,
            directory_excludes: vec![],
        ...
        SSHFileMapping {
            ...
            module: "oh_my_pi".to_string(),
            local_path: "~/.omp/agent/AGENTS.md".to_string(),
            remote_path: "~/.omp/agent/AGENTS.md".to_string(),
            enabled: true,
            is_pattern: false,
            is_directory: false,
            directory_excludes: vec![],
        ...
        SSHFileMapping {
            ...
            module: "oh_my_pi".to_string(),
            local_path: "~/.omp/agent/RULES.md".to_string(),
            remote_path: "~/.omp/agent/RULES.md".to_string(),
            enabled: true,
            is_pattern: false,
            is_directory: false,
            directory_excludes: vec![],
        ...
        SSHFileMapping {
            ...
            local_path: "~/.hermes/config.yaml".to_string(),
            remote_path: "~/.hermes/config.yaml".to_string(),
            enabled: true,
            is_pattern: false,
            is_directory: false,
            directory_excludes: vec![],
        ...
        SSHFileMapping {
            ...
            module: "hermes".to_string(),
            local_path: "~/.hermes/SOUL.md".to_string(),
            remote_path: "~/.hermes/SOUL.md".to_string(),
            enabled: true,
            is_pattern: false,
            is_directory: false,
            directory_excludes: vec![],
        ...
        SSHFileMapping {
            ...
            local_path: "~/.dsh/settings.yaml".to_string(),
            remote_path: "~/.dsh/settings.yaml".to_string(),
            enabled: true,
            is_pattern: false,
            is_directory: false,
            directory_excludes: vec![],
        ...
        SSHFileMapping {
            ...
            module: "dsh".to_string(),
            local_path: "~/.dsh/.credentials.yaml".to_string(),
            remote_path: "~/.dsh/.credentials.yaml".to_string(),
            enabled: true,
            is_pattern: false,
            is_directory: false,
            directory_excludes: vec![],
        ...
        SSHFileMapping {
            ...
            module: "kimi".to_string(),
            local_path: "~/.kimi-code/AGENTS.md".to_string(),
            remote_path: "~/.kimi-code/AGENTS.md".to_string(),
            enabled: true,
            is_pattern: false,
            is_directory: false,
            directory_excludes: vec![],
        ...
        SSHFileMapping {
            ...
            module: "kimi".to_string(),
            local_path: "~/.kimi-code/credentials".to_string(),
            remote_path: "~/.kimi-code/credentials".to_string(),
            enabled: true,
            is_pattern: false,
            is_directory: true,
            directory_excludes: vec![],
        ...
        SSHFileMapping {
            ...
            module: "kimi".to_string(),
            local_path: "~/.kimi-code/plugins".to_string(),
            remote_path: "~/.kimi-code/plugins".to_string(),
            enabled: true,
            is_pattern: false,
            is_directory: true,
            directory_excludes: vec![],
        ...
        // Claude Desktop - config-file module. GUI remote sync is best-effort and
        // disabled by default.
        SSHFileMapping {
...
mod tests {
    ...
    #[test]
    fn defaults_backfill_v15_only_adds_kimi_mappings_for_existing_v14_users() {
        let kimi_ids = [
            "kimi-config",
            "kimi-prompt",
            "kimi-credentials",
